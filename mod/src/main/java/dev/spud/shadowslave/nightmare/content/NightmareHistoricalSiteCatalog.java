 ...
 * become ruin, wilderness, settlement, or another later state.
 *
 * <p>This catalogue identifies the same place across eras. It does not make a
 * challenger's altered Nightmare history rewrite the shared later Dream Realm.</p>
 */
public final class NightmareHistoricalSiteCatalog {
    ...
    /**
     * Representative era-linked proof retained in base. Exact names, values,
     * weights and later ruin details are project DESIGN rather than claimed canon.
     */
