...
public final class NightmareFactionCurrentAnswerFramingCatalog {
    ...
    public enum AnswerFrame { DIRECT, LIMITED, CONDITIONAL, REFUSED }
    ...
    public static List<Primitive> waveOne() {
        return List.of(
                p("direct_present_goal", AnswerFrame.DIRECT, "A Present Goal Stated",
                        ...
                        List.of("Record the stated goal.", "Ask about its scope.", "Keep hidden motive unresolved."),
                        Set.of("goal", "current", "scope"),
                        List.of("The current statement is shown separately from older history.", "No truth marker is attached to the line."),
                ...
                p("direct_access_status", AnswerFrame.DIRECT, "Current Access Answered",
                        "The faction gives a present statement about access without changing the route itself.",
                        "For this meeting, the stated access is the one we have named.",
                        List.of("Record the stated access.", "Ask for the boundary.", "Verify world state separately."),
                        Set.of("access", "current", "boundary"),
                        List.of("The statement is displayed beside the current access question.", "World-state presentation remains visually separate."),
                        "A direct access answer cannot unlock terrain, establish ownership, guarantee safety, or prove authority to grant passage."),
                p("direct_open_matter_position", AnswerFrame.DIRECT, "A Current Position Stated",
                        ...
                        List.of("Compare it with the old record.", "Ask what changed.", "Leave truth unresolved beyond the statement."),
                        Set.of("open", "position", "current"),
                        List.of("Past and present statements appear side by side.", "Differences are highlighted without a deception label."),
                ...
                p("direct_decline_acknowledged", AnswerFrame.DIRECT, "Refusal Acknowledged",
                        "The faction acknowledges a player's refusal without inventing a relationship consequence.",
                        "Your refusal is understood for this proposal.",
                        List.of("End this topic.", "Ask whether another issue remains.", "Leave future reaction unresolved."),
                        Set.of("decline", "terms", "scope"),
                        List.of("The declined proposal is marked closed for this exchange only.", "No hostility or reputation indicator is generated."),
                ...
                p("limited_partial_goal", AnswerFrame.LIMITED, "Only Part of the Goal Given",
                        ...
                        List.of("Record the stated portion.", "Ask what remains undisclosed.", "Do not fill the gap by inference."),
                        Set.of("goal", "limited", "uncertainty"),
                        List.of("The answered portion has an explicit unresolved remainder.", "No hidden content is generated behind the gap."),
                ...
                p("limited_access_scope", AnswerFrame.LIMITED, "Access Scope Only",
                        ...
                        List.of("Keep the answer route-specific.", "Ask about another area separately.", "Treat silence elsewhere as unresolved."),
                        Set.of("access", "limited", "route"),
                        List.of("Only the named route receives an answer marker.", "Other locations remain unclassified rather than closed or open."),
                ...
                p("limited_source_only", AnswerFrame.LIMITED, "Source Named, Claim Unsettled",
                        "The faction identifies the source it relies on without establishing that source as true or complete.",
                        "That is the source for our answer. We are not adding more to it now.",
                        List.of("Record the source.", "Compare it with other evidence.", "Preserve disagreement if present."),
                        Set.of("source", "evidence", "limited"),
                        List.of("The source is linked without a verification badge.", "Contradictory evidence can remain visible beside it."),
                ...
                p("limited_no_broader_commitment", AnswerFrame.LIMITED, "No Broader Commitment Given",
                        "The faction answers the immediate point but leaves broader commitment unsettled.",
                        "Our answer goes no further than this matter.",
                        List.of("Keep the scope narrow.", "Ask about broader terms separately.", "Do not infer loyalty from cooperation."),
                        Set.of("commitment", "limited", "scope"),
                        List.of("The answer ends at a visible scope boundary.", "Relationship history remains separate from the current statement."),
                ...
                p("conditional_after_verification", AnswerFrame.CONDITIONAL, "Answer Depends on Verification",
                        "The faction states that its answer depends on a named check without deciding that check.",
                        "If that point is verified, our answer applies as stated.",
                        List.of("Ask what counts as verification.", "Record the condition.", "Leave fulfillment to current state."),
                        Set.of("condition", "verification", "evidence"),
                        List.of("The condition is displayed without a completion mark.", "Relevant evidence can be linked without automatic resolution."),
                ...
                p("conditional_after_exchange", AnswerFrame.CONDITIONAL, "Answer Tied to an Exchange",
                        "The faction makes its answer contingent on a stated exchange without performing that exchange.",
                        "Our answer changes only if the named exchange is actually made.",
                        List.of("Ask for the exact exchange.", "Decline the exchange.", "Leave the answer conditional."),
                        Set.of("condition", "exchange", "terms"),
                        List.of("The exchange appears as an unfulfilled condition.", "No inventory or access state is mutated by the line."),
                ...
                p("conditional_named_boundary", AnswerFrame.CONDITIONAL, "Answer Holds Within a Boundary",
                        ...
                        List.of("Ask where the boundary ends.", "Ask what changes it.", "Recheck if circumstances change."),
                        Set.of("condition", "boundary", "current"),
                        List.of("The answer is visibly attached to its stated boundary.", "Changing circumstances do not choose a replacement answer."),
                ...
                p("conditional_named_actor", AnswerFrame.CONDITIONAL, "Answer Limited to a Named Actor",
                        "The faction states that the answer applies only to a participant or role supplied by current state.",
                        "This answer applies only to the person or role already named.",
                        List.of("Confirm the named scope.", "Ask whether others are excluded.", "Do not generalize the answer."),
                        Set.of("condition", "actor", "scope"),
                        List.of("The scoped actor is shown as context, not generated here.", "Other actors remain outside the answer unless separately resolved."),
                ...
                p("refused_no_answer", AnswerFrame.REFUSED, "No Answer Given",
                        ...
                        List.of("Record the refusal.", "Ask a different bounded question.", "End the exchange."),
                        Set.of("refusal", "uncertainty", "boundary"),
                        List.of("The unanswered field remains explicitly unresolved.", "No motive or guilt marker replaces the missing answer."),
                ...
                p("refused_access_question", AnswerFrame.REFUSED, "Access Question Refused",
                        "The faction refuses to answer whether current access applies; refusal does not become a closed route.",
                        "We will not answer the access question here.",
                        List.of("Leave access unresolved.", "Seek another authorized source.", "Choose another known option if one exists."),
                        Set.of("refusal", "access", "route"),
                        List.of("The access field remains unresolved rather than denied.", "No route lock or danger marker is created."),
                ...
                p("refused_open_matter", AnswerFrame.REFUSED, "Open Matter Left Unanswered",
                        ...
                        List.of("Keep the old matter unresolved.", "Return to the present issue.", "End the exchange without a verdict."),
                        Set.of("refusal", "open", "history"),
                        List.of("The old unresolved record remains beside the new refusal.", "The refusal is current context rather than a final judgment."),
                ...
                p("refused_without_escalation", AnswerFrame.REFUSED, "Refusal Without Escalation",
                        "The faction declines to answer without inventing a threat or immediate escalation.",
                        "No answer. That is all for this question.",
                        List.of("Accept the refusal for now.", "Ask whether another topic is open.", "Disengage."),
                        Set.of("refusal", "disengage", "relationship"),
                        List.of("The exchange can end without combat or hostility presentation.", "Future stance remains unset until supplied by later state."),
    ...
    public static Selection compose(long seed, String scenarioId, String factionId, String questionId,
        ...
        String question = opaqueId(questionId, "questionId");
        ...
        List<Primitive> candidates = waveOne().stream().filter(p -> p.frame() == checkedFrame)
        ...
        List<Primitive> preferred = best > 0
                ...
                : candidates;
        String key = scenario + "|" + faction + "|" + question + "|" + answer + "|" + checkedFrame.name()
        ...
        return new Selection(GENERATOR_VERSION, seed, scenario, faction, question, answer, checkedFrame,
    ...
    private static Primitive p(String id, AnswerFrame frame, String title, String read, String line,
                               List<String> responses, Set<String> tags, List<String> cues, String boundary) {
        return new Primitive(id, frame, title, read, line, responses, tags, cues, boundary);
    }
    ...
    private static String stableId(String value) {
        ...
        if (!checked.matches("[a-z0-9][a-z0-9_-]*")) throw new IllegalArgumentException("invalid catalogue id");
        return checked;
    }

    private static String opaqueId(String value, String name) { return text(value, name); }
    ...
    private static List<String> exactTextList(List<String> values, int size, String name) {
        ...
        return List.copyOf(values.stream().map(value -> text(value, name + " entry")).toList());
    }
