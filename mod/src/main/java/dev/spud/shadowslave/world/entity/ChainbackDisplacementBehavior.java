 ...
 * This class only turns that already-authored pressure into replaceable Minecraft timing, motion,
 * and recovery values.</p>
 */
public final class ChainbackDisplacementBehavior {
    ...
    public static final int CONNECTED_RECOVERY_TICKS = 8;
    public static final int EVADED_RECOVERY_TICKS = 18;
    ...
    /**
     * A clean evade earns a larger punish window than absorbing the pull. Both outcomes still force
     * Chainback to finish the committed action before ordinary pursuit/melee can resume.
     */
    public static int recoveryTicks(boolean pullConnected) {
        return pullConnected ? CONNECTED_RECOVERY_TICKS : EVADED_RECOVERY_TICKS;
    }
