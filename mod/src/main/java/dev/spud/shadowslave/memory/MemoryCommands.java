        ...
        event.getDispatcher().register(Commands.literal("shadowslave_memory")
                .then(Commands.literal("summon")
                        .then(Commands.literal("ash_compass")
                                .executes(context -> summon(context.getSource().getPlayerOrException(), "Ash Compass", MemoryManifestationService.summonAshCompass(context.getSource().getPlayerOrException()))))
                        .then(Commands.literal("blackwater_hook")
                                .executes(context -> summon(context.getSource().getPlayerOrException(), "Blackwater Hook", MemoryManifestationService.summonBlackwaterHook(context.getSource().getPlayerOrException())))))
                .then(Commands.literal("dismiss")
                        .then(Commands.literal("ash_compass")
                                .executes(context -> dismiss(context.getSource().getPlayerOrException(), "Ash Compass", MemoryManifestationService.dismissAshCompass(context.getSource().getPlayerOrException()))))
                        .then(Commands.literal("blackwater_hook")
                                .executes(context -> dismiss(context.getSource().getPlayerOrException(), "Blackwater Hook", MemoryManifestationService.dismissBlackwaterHook(context.getSource().getPlayerOrException()))))));
    }
