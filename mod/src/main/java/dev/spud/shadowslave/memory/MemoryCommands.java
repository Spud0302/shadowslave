    ...
    public static void register(RegisterCommandsEvent event) {
        event.getDispatcher().register(Commands.literal("shadowslave_memory")
                .then(Commands.literal("summon")
                        ...
                        .then(Commands.literal("stonewake_shield").executes(context -> summon(context.getSource().getPlayerOrException(), "Stonewake Shield", MemoryManifestationService::summonStonewakeShield))))
                .then(Commands.literal("dismiss")
                        ...
                        .then(Commands.literal("stonewake_shield").executes(context -> dismiss(context.getSource().getPlayerOrException(), "Stonewake Shield", MemoryManifestationService::dismissStonewakeShield)))));
    }
