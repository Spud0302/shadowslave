...
public final class EchoOwnershipService {
    ...
    public static EchoOwnershipData setCommandMode(ServerPlayer player, ResourceLocation echoId,
    ...
    public static EchoOwnershipData setCargo(ServerPlayer player, ResourceLocation echoId,
