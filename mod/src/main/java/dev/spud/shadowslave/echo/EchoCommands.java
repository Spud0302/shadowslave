...
public final class EchoCommands {
    ...
    public static void register(RegisterCommandsEvent event) {
        event.getDispatcher().register(Commands.literal("shadowslave_echo")
                .then(Commands.literal("summon").then(Commands.literal("ash_burrower")
                        .executes(context -> summonAshBurrower(context.getSource().getPlayerOrException()))))
                .then(Commands.literal("dismiss").then(Commands.literal("ash_burrower")
                ...
                .then(Commands.literal("carry").then(Commands.literal("ash_burrower")
                        .executes(context -> carryAshBurrower(context.getSource().getPlayerOrException()))))
                .then(Commands.literal("unload").then(Commands.literal("ash_burrower")
                        .executes(context -> unloadAshBurrower(context.getSource().getPlayerOrException())))));
    }
