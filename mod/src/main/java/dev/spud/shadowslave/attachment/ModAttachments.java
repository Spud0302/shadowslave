...
public final class ModAttachments {
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<BlackwaterHookAnchorData>> BLACKWATER_HOOK_ANCHOR = ATTACHMENTS.register("blackwater_hook_anchor", () -> AttachmentType.builder(BlackwaterHookAnchorData::empty).serialize(BlackwaterHookAnchorData.CODEC.codec()).build());
