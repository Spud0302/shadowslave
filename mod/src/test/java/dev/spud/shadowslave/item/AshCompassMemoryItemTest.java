...
class AshCompassMemoryItemTest {
    ...
    void readingReportsAnchoredRefugeDirectionAndDistance() {
        ...
        assertEquals("refuge east, about 10 blocks away",
                AshCompassMemoryItem.reading(new BlockPos(0, 64, 0), new BlockPos(10, 80, 0)));
        assertEquals("refuge northwest, about 14 blocks away",
                AshCompassMemoryItem.reading(new BlockPos(0, 64, 0), new BlockPos(-10, 64, -10)));
    }
