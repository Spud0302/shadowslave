...
class PreviewResetServiceTest {
    ...
    void resetCompletesAllMutationsBeforeOneAuthoritativeSnapshot() {
        ...
        assertEquals(List.of("abort_nightmare", "reset_soul", "clear_soul_identity", "clear_attributes", "clear_memories", "clear_imported_identity", "clear_preview_power", "sync"), operations.calls);
