...
The reviewed #220 -> #221 delta was ported onto `gpt/ash-compass-alpha-integration` from current `main@955bd16ce905590c5e72a21e55a224616207adb6` after the historical #221 head had fallen 20 commits behind main. Comparison showed none of the seven Ash Compass runtime/test/evidence files changed in those intervening main commits, so the port preserves the reviewed behavior without importing stale branch ancestry.

Historical ancestry still proves #221 contains #220 head `b2a1b89e77bb39beca3a23662eb5e9eff581207c` by 6 commits ahead / 0 behind, and Preview Gates #240 passed on #221 exact head `501f7dcc17d1534929f9486e594a4e0fd06691c5`. The new current-main integration head requires its own hosted gate before #220 or #221 is marked superseded.
