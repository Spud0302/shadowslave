...
- **Purpose:** lore research, not Minecraft implementation or game design.
...
5. Section E — Soul Cores and Echoes
6. Section F — vocabulary, institutions and Spell tone

## Promotion policy

The existing `Shadow Slave - Lore Reference` note is still the project's concise systems bible.
Research in this directory may disagree with it while verification is underway. When a finding is
stable, update the systems bible explicitly rather than silently allowing the two documents to drift.
