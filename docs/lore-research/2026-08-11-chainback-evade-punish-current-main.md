...
**Implementation branch:** `gpt/chainback-evade-punish-refresh`
...
- **INFERRED:** a creature-specific dangerous action should expose observable physical counterplay in the physical game rather than being an invisible instantaneous stat check.
