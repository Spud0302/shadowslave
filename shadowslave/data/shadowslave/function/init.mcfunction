...
tellraw @a [{"text":"[Shadow Slave] ","color":"dark_gray"},{"text":"v1.4.4","color":"light_purple","bold":true},{"text":" — The Spell stirs.","color":"dark_gray","italic":true},{"text":"  (testing commands: ","color":"dark_gray"},{"text":"shadowslave:test/help","color":"aqua"},{"text":")","color":"dark_gray"}]
