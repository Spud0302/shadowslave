...
# agree, because a version string that lies is worse than none at all. Development/test
# commands stay in README and test/help rather than being advertised to every player.
tellraw @a [{"text":"[Shadow Slave] ","color":"dark_gray"},{"text":"v1.4.9","color":"light_purple","bold":true},{"text":" — The Spell stirs.","color":"dark_gray","italic":true}]
