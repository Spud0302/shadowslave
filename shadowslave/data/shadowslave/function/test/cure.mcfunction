...
execute if score @s ss_rank matches 1.. run tellraw @s {"text":"[Shadow Slave] You are Awakened. The Spell cannot lose interest now — use shadowslave:test/reset.","color":"red"}
