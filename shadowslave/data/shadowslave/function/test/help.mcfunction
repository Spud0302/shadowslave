...
tellraw @s [{"text":"shadowslave:test/flaw/baseline","color":"aqua"},{"text":" force baseline Flaw family","color":"gray"}]
tellraw @s [{"text":"shadowslave:test/flaw/bloodied","color":"aqua"},{"text":" force near-collapse Flaw family","color":"gray"}]
tellraw @s [{"text":"shadowslave:test/flaw/hungry","color":"aqua"},{"text":"   force hunger Flaw family","color":"gray"}]
tellraw @s [{"text":"shadowslave:test/flaw/fled","color":"aqua"},{"text":"     force distance/retreat Flaw family","color":"gray"}]
