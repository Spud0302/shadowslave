...
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| 1.1 | **Teleporting a sleeping player.** Does the entry teleport wake you out of the bed, or leave you stuck in it?                                      | Sleep in a bed as a Sleeper.                                                                                           | Wrap the teleport in `schedule function shadowslave:nightmare/enter_delayed 1t` so it runs the tick after the bed animation starts. |
